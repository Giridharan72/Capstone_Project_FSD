...
function Update() {
    ...
    const handleUserSelectChange = async (e) => {
        ...
        try {
            const response = await axios.get(`https://capstone-project-fsd.onrender.com/api/products/${userId}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://capstone-project-fsd.onrender.com/api/products/${selectedUserId}`, {
