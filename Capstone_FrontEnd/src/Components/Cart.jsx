...
const Cart = () => {
    ...
    const [customerId, setCustomerId] = useState('6601abaf11d9857e7006a045');
    ...
    const fetchCustomerDetails = async () => {
        try {
            const response = await fetch(`https://capstone-project-fsd.onrender.com/api/customers/${customerId}`);
